// -----------------------------------------------------------------------
// <copyright file="BouncyConeLight.cs" company="">
...
namespace CelestialEngine.TechDemo
{
    ...
    /// A bouncy cone light
    /// </summary>
    /// <seealso cref="CelestialEngine.Game.PostProcess.Lights.ConeLight" />
    public class BouncyConeLight : ConeLight
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BouncyConeLight"/> class.
        /// </summary>
        /// <param name="world">The <see cref="T:CelestialEngine.Core.World" /> in which the instance lives.</param>
        public BouncyConeLight(World world)
            : base(world)
        {
        }
